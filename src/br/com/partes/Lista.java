...
public class Lista {
	 ...
	 * Construtor.
	 * @param elemento
	 * Passe o elemento que deseja usar.
	 ...
	 * @param indice
	 * Passe o indice do item da lista que deseja selecionar.
	 * @author Rogério Figueiredo.
	 */
	 ...
	 * @param valor
	 * Passe o valor do item da lista que deseja selecionar.
	 * @author Rogério Figueiredo.
	 */
	 ...
	 * @param nome
	 * Passe o nome do item da lista que deseja selecionar.
	 * @author Rogério Figueiredo.
	 */
	 ...
	 * @return
	 * Retorna todas as opções da lista.
	 * @author Rogério Figueiredo.
	 */
	...
	public void removerSelecao(){	
		...
		if (e.isMultiple()){ e.deselectAll();
		}else{ selecionarOpcaoPeloIndice(0);}		
	}
